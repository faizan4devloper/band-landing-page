...
import getCardsData from "./data"; // Import the getCardsData function
      ...
      {loading ? ( // Show loader while loading is true
        ...
        <>
          ...
          <Routes>
            ...
            />
            <Route path="/dashboard" element={<SideBarPage cardsData={cardsData} />} />
            <Route
              path="/all-cards"
