    ...
    <div className={styles.app}>
      {loading ? ( // Show loader while loading is true
        <div className={styles.loader}>
          <BarLoader color="#5931d5" loading={loading} width={150} />
        </div>
      ) : (
        <>
          <Header />
...
import AllCardsPage from "./components/Cards/AllCardsPage";
import { cardsData as initialCardsData } from "./data";
import { ClipLoader, PulseLoader, BeatLoader } from "react-spinners"; // Import loaders
...
const MainApp = () => {
  ...
  return (
    <div className={styles.app}>
      {loading ? ( // Show loader while loading is true
        <div className={styles.loader}>
          <ClipLoader color="#5931d5" loading={loading} size={50} />
          <PulseLoader color="#5931d5" loading={loading} size={15} margin={2} />
