...
.formHead {
    ...
    border-bottom: 2px solid #7ca2e1; /* Adds a bottom border for visual separation */
    padding-bottom: 10px;
}
...
.dataTable {
    width: 100%;
    border-collapse: collapse; /* For clean lines between cells */
...
.tableHeader {
    ...
    background-color: #f1f5f9; /* Light gray for header background */
    padding: 16px 12px;
    text-align: left;
