i want the add add button on the questionBlock after i hit the that button then the question and answer open in the chatbot and also and i want in chatbot chatbot follow up question
