Uncaught Error: Objects are not valid as a React child (found: object with keys {transition, skills, outcome, metadata}). If you meant to render a collection of children, use an array instead.
