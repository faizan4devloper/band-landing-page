      ...
      {maximizedImage && (
        <div className={styles.overlay}>
          ...
          <div className={styles.navigationButtons}>
            <FontAwesomeIcon icon={faChevronLeft} onClick={handlePrevImage} className={styles.navButton} />
            <FontAwesomeIcon icon={faChevronRight} onClick={handleNextImage} className={styles.navButton} />
          </div>
        </div>
      )}
      {maximizedImage && (
