...
# Define your Lambda function API endpoint
LAMBDA_API_URL = "https://your-api-id.execute-api.region.amazonaws.com/your-stage/your-resource"
...
hidden_input = st.text_input("Hidden Input", key="hidden_input", label_visibility="collapsed")

def call_lambda_function(value):
    try:
        response = requests.post(LAMBDA_API_URL, json={"input": value})
...
if hidden_input:
    result = call_lambda_function(hidden_input)
    st.write("Lambda response:", result)
