...
i have this 3 components now the sidebar and formdisplay will takes full screen is its good but i want adjust the UploadDocuments like animation or any dynamic like after i click the open preview button then slidely open or comes the UploadDocuments form right side and i want the after UploadDocuments open or visible then the FormDisplay width deacrease to the 30% pixel and also deacrease the width of the sidebar cause they are perfectly display until the UploadDocuments open and after i click close preview then the sidebar and formdisplay become normal means takes full width.
