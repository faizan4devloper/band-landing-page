...
import { faPaperPlane, faWandSparkles, faTimes, faTrashAlt, faComments, faWindowMinimize } from '@fortawesome/free-solid-svg-icons';
...
const Chatbot = () => {
  ...
  const minimizeChatbot = () => {
    setIsOpen(false); // Minimize by closing the chat window but keep the chat history intact
  };
