...
//   }
const rcNumber = "";
const handleVerify = (clid, summary,selectedPolicy) => {
  console.log("In Handle Verify RecNum:",clid);
  console.log("In Handle Verify psid:",selectedPolicy);
  
    navigate('/verify', {
      state: { clid, summary, selectedPolicy }, // Pass recNum and summary to Verify
    });
  };
