...
const [isTraceLoading, setIsTraceLoading] = useState(false);
  ...
  const websocketUrl = "wss://q2tlfu7m4l.execute-api.us-east-1.amazonaws.com/production/";
 
  const httpEndpoint = "https://vbdktpbj5l.execute-api.us-east-1.amazonaws.com/prod/uploadImage";
  
  const traceApiEndpoint = "https://20c830xflg.execute-api.us-east-1.amazonaws.com/dev/tracesData";
