    ...
    if http_method == 'GET':
      ...
      html_content = f"""
        ...
        <head>
            ...
            <style>
                ...
                #chat-container {{  width: 500px;  border: 1px solid #ccc;  padding: 10px;  background-color: #fff;  box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);border-radius: 10px;}}
                ...
                .user-message, .bot-message {{ text-align: l; margin: 10px; padding: 10px; background-color: #CCCCFF; border-radius: 10px; }}
      ...
      return {
        ...
        try:
            ...
            test = json.dumps({'imageUrl': image_url})
            print(test)
            return {
                'statusCode': 200,
                'headers': {
